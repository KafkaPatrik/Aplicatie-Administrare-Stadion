...
public class Eveniment{
    ...
    private int reservedParkingSpots;
    ...
    public Eveniment(int event_Id,int event_max_participants,String event_Title,String event_Location,String event_Date,String event_Description,int parkingPrice, int maxParkingSpots) {
